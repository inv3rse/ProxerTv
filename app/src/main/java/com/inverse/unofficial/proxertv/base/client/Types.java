...
final class Types {
    ...
    static boolean equals(Type a, Type b) {
        if (a == b) {
            ...
            Type[] aTypeArguments = pa instanceof ParameterizedTypeImpl ? ((ParameterizedTypeImpl) pa).typeArguments : pa
                    .getActualTypeArguments();
            Type[] bTypeArguments = pb instanceof ParameterizedTypeImpl ? ((ParameterizedTypeImpl) pb).typeArguments : pb
                    .getActualTypeArguments();
            ...
            return Arrays.equals(wa.getUpperBounds(), wb.getUpperBounds()) && Arrays.equals(wa.getLowerBounds(), wb
                    .getLowerBounds());
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            if (rawType instanceof Class<?>) {
                ...
                boolean isStaticOrTopLevelClass = Modifier.isStatic(rawTypeAsClass.getModifiers()) || rawTypeAsClass
